...
def main():
    """ Calls the test functions. As you implement CapitalT method uncomment
...
def run_test_simple_t():
    """ Tests for the __init__ method and attach_to method. See the simple_t
    PDF for expected output. """
    print()
    print('--------------------------------------------------')
...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        # --------------------------------------------------------------
        self.p1 = intersection_center
        self.width = width
        self.height = height
        self.thicc = letter_thickness
        p1 = rg.Point(self.p1.x-letter_thickness/2,
                      self.p1.y-letter_thickness/2)
        p2 = rg.Point(self.p1.x+letter_thickness/2,
                      self.p1.y + height - letter_thickness/2)
        p3 = rg.Point(self.p1.x-width/2,
                      self.p1.y-letter_thickness/2)
        p4 = rg.Point(self.p1.x+width/2,
                      self.p1.y+letter_thickness/2)
    ...
    def clone(self):
        ...
        #     clone.pdf.
        # --------------------------------------------------------------
        newt = CapitalT(self.p1, self.width, self.height, self.thicc)
